    ...
    <form action="{{ route('asistencias.destroy', $asistencia->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="grupo_nombre" value="{{ optional($asistencia->grupo)->nombre }}" disabled>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <label for="estudiante_nombre" class="form-label">Estudiante</label>
                <input type="text" class="form-control" id="estudiante_nombre" value="{{ optional($asistencia->estudiante)->nombre }} {{ optional($asistencia->estudiante)->apellido }}" disabled>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
